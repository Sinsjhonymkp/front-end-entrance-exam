...
https://front-end-entrance-exam-one.vercel.app/
...
- Для редактирования уровня владения языком нажмите на заполненную часть progressBar и введите в промт нужное значение цифроми от 0 до 100

все изменения (сохранение текста, избранные карточки)
